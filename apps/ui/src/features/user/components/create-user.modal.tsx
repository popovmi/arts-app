...
export const CreateUserModal: FC = () => {
    ...
    return (
        ...
        >
            <Form labelCol={{ span: 8 }} wrapperCol={{ span: 16 }} name="newUser" form={form} labelAlign="left">
                <Spin spinning={isLoading}>
                    <Item label="Логин" name="username" rules={[{ required: true, message: 'Обязательно!' }]}>
                        <Input />
                    </Item>
                    <Item label="Пароль" name="password" rules={[{ required: true, message: 'Обязательно!' }]}>
                        <Password />
                    </Item>
                    <Item label="Полное имя" name="fullName" rules={[{ required: true, message: 'Обязательно!' }]}>
                        <Input />
                    </Item>
                </Spin>
                {isError && (
