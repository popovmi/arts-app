...
export type AddArtCommentMutation = {
    __typename?: 'Mutation';
    addArtComment: {
        __typename?: 'ArtComment';
        id: number;
...
export type AddProjectCommentMutation = {
    __typename?: 'Mutation';
    addProjectComment: {
        __typename?: 'ProjectComment';
        id: number;
...
export type UpdateArtCommentMutation = {
    __typename?: 'Mutation';
    updateArtComment: {
        __typename?: 'ArtComment';
        id: number;
...
const injectedRtkApi = api.injectEndpoints({
    endpoints: (build) => ({
        ...
        updateProjectComment: build.mutation<
            UpdateProjectCommentMutation,
            UpdateProjectCommentMutationVariables
        >({
